...
public class T1_Circle_Drag_N_Drop {
    ...
    @Test
    public void drag_and_drip_test(){
        //TC #: Drag and drop
        ...
        // this is a ready built-in method
        // actions.dragAndDrop(smallCircle,bigCircle).perform(); // the first one is source and the other argument is the target
        // (what to pick up, where do you want to drop it)
        // Another method (By chaining the actions together)
        actions.clickAndHold(smallCircle).
                pause(2000).moveToElement(bigCircle).
